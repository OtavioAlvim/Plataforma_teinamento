...
$result_curso = "SELECT * FROM videos WHERE type ='compilart' and name LIKE '%$valor_pesquisar%'";
...
$result_cursos = "SELECT * FROM videos WHERE type ='compilart' and name LIKE '%$valor_pesquisar%' limit $incio, $quantidade_pg";
				...
				<ul class="pagination">
					<li>
						...
						if($pagina_anterior != 0){ ?>
							<a href="pesquisar-compilart.php?pagina=<?php echo $pagina_anterior; ?>&pesquisar=<?php echo $valor_pesquisar; ?>" aria-label="Previous">
					...
					for($i = 1; $i < $num_pagina + 1; $i++){ ?>
						<li><a href="pesquisar-compilart.php?pagina=<?php echo $i; ?>&pesquisar=<?php echo $valor_pesquisar; ?>"><?php echo $i; ?></a></li>
					<?php } ?>
					<li>
						<?php
						if($pagina_posterior <= $num_pagina){ ?>
							<a href="pesquisar-compilart.php?pagina=<?php echo $pagina_posterior; ?>&pesquisar=<?php echo $valor_pesquisar; ?>" aria-label="Previous">
